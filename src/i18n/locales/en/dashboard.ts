const en: Record<string, string> = {
  ...
  'dashboard.greeting': 'Hi {name} — here is what needs you today.',
  'dashboard.focusOverdue': 'Your overdue issues',
  'dashboard.focusDueSoon': 'Due in the next 3 days',
  'dashboard.focusInProgress': 'In progress',
  'dashboard.focusInReview': 'In review',
  'dashboard.allClearTitle': 'You are all caught up',
  ...
  'dashboard.noMyIssues': 'No open issues are assigned to you right now.',
